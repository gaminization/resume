...
This repository contains the flagship production LaTeX source (`resume.tex`), compiled single-page PDF (`resume.pdf`), official evidence attestation mapping (`Evidence_Mapping.md`), and comprehensive engineering report (`Resume_Optimization_Report.md`) for **Garv Arora**, upgraded with full 10pt body font size (`\normalsize`) across all bullets and section items for maximum recruiter readability, 638 total words (~610 body words), single-page fit (`Pages: 1`), and optimized for high interview conversion across **Software Engineering (SWE), Robotics, Autonomous Systems, Embedded Systems, Computer Vision, ADAS, and AI/ML Engineering**.

---

## Deliverable Files

- **`resume.tex`**: Production LaTeX source code upgraded with full 10pt body font size across all bullet points, subheadings, patents, awards, certifications, and technical skills, Samsung PRISM dates (`Apr 2026 -- Oct 2026`), single-year project dates (`2026`, `2025`), 638 total words (~610 body words), verification hyperlinks, and plaintext hyperref configuration.
