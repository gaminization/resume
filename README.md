...
This repository contains the flagship production LaTeX source (`resume.tex`), compiled single-page PDF (`resume.pdf`), official evidence attestation mapping (`Evidence_Mapping.md`), and comprehensive engineering report (`Resume_Optimization_Report.md`) for **Garv Arora**, engineered using classic Jake's Resume template macro architecture, IRDC 2025 Top 5 Finalist achievement inclusion, 613 total words (~580 body words), single-page fit (`Pages: 1`), and optimized for high interview conversion across **Software Engineering (SWE), Robotics, Autonomous Systems, Embedded Systems, Computer Vision, ADAS, and AI/ML Engineering**.

---

## Deliverable Files

- **`resume.tex`**: Production LaTeX source code built on classic Jake's Resume template macro architecture with exact `IRDC 2025: Top 5 Finalist` achievement entry, Samsung PRISM dates (`Apr 2026 -- Oct 2026`), single-year project dates (`2026`, `2025`), 613 total words (~580 body words), verification hyperlinks, and plaintext hyperref configuration.
