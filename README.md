...
This repository contains the flagship production LaTeX source (`resume.tex`), compiled single-page PDF (`resume.pdf`), official evidence attestation mapping (`Evidence_Mapping.md`), and comprehensive engineering report (`Resume_Optimization_Report.md`) for **Garv Arora**, engineered directly from the **89-score baseline** (`dbdb39a`) and optimized for high interview conversion across **Software Engineering (SWE), Robotics, Autonomous Systems, Embedded Systems, Computer Vision, ADAS, and AI/ML Engineering**.

---

## Deliverable Files

- **`resume.tex`**: Production LaTeX source code restored from commit `dbdb39a` baseline with split SEDS India entries, 100% unique action verbs, verification hyperlinks, and plaintext hyperref configuration.
...
- **`CHANGELOG.md`**: Complete evolutionary changelog and audit log built on top of the 89-score `dbdb39a` baseline.
